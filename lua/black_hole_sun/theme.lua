...
theme.set_highlights = function()
  ...
  hl(0, "Number", { fg = c.light_red, bg = 'NONE' })
  ...
  hl(0, 'LualineIA', { fg = c.neon, bg = c.brightred })
  hl(0, "LualineIB", { fg = c.search_green, bg = c.brightred })
  hl(0, "LualineIC", { fg = c.gray, bg = c.dark })
  hl(0, 'LualineVA', { fg = c.neongreen, bg = c.darkblue })
  hl(0, "LualineVB", { fg = c.darkblue, bg = c.shellblue })
  hl(0, "LualineVC", { fg = c.brightgreen, bg = c.dark })
  hl(0, 'LualineRA', { fg = c.noen, bg = c.dark })
  hl(0, "LualineRB", { fg = c.search_green, bg = c.dark })
  hl(0, "LualineRC", { fg = c.gray, bg = c.dark })
  hl(0, 'LualineCA', { fg = c.darkblue, bg = c.neongreen })
  hl(0, "LualineCB", { fg = c.noen, bg = c.search_green })
  hl(0, "LualineCC", { fg = c.gray, bg = c.dark })
  hl(0, 'LualineEA', { fg = c.bg, bg = c.inactivegray })
  hl(0, "LualineEB", { fg = c.bg, bg = c.inactivegray })
  hl(0, "LualineEC", { fg = c.bg, bg = c.inactivegray })
  ...
  hl(0, "NvimTreeNormal", { fg = c.light_gray, bg = c.bg })
