...
theme.set_highlights = function()
  ...
  hl(0, "CursorLineNr", { fg = c.dark, bg = 'NONE', bold=true, })
  ...
  hl(0, "Search", { fg = c.bg, bg = c.search_blue })
  hl(0, "IncSearch", { fg = c.search_orange, bg = c.bg })
  hl(0, "Substitute", { fg = c.bg, bg = c.search_orange })
